...
async function checkStock() {
  try {
    ...
    if (wholeSet && (wholeSet.stock.onlineStock > 0 || wholeSet.stock.onlineLockStock > 0)) {
      inStock = true;
      ...
      console.log(`Whole set is not in stock! Stock: ${wholeSet.stock.onlineStock}, Lock Stock: ${wholeSet.stock.onlineLockStock}`);
     
    }

    if (singleBox && (singleBox.stock.onlineStock > 0 || singleBox.stock.onlineLockStock > 0)) {
      inStock = true;
      message += `Single box:\n- Available: ${singleBox.stock.onlineStock}\n- Locked: ${singleBox.stock.onlineLockStock}\n`;
    } else {
      console.log(`Single box is not in stock! Stock: ${singleBox.stock.onlineStock}, Lock Stock: ${singleBox.stock.onlineLockStock}`);
    }
